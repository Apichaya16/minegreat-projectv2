    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3 font-weight-bold">API MINEGREAT</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#การผ่อนชำระ" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-coins text-gray-400	"></i>
                    <span>การผ่อนชำระ</span>
                </a>
                <div id="การผ่อนชำระ" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#สถานะการผ่อน" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                    <span>สถานะการผ่อน</span>
                </a>
                <div id="สถานะการผ่อน" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <h6 class="collapse-header">Custom Utilities:</h6> --}}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800 font-weight-bold">@yield('name_page')</h1>
                    @yield('button_page')
                </div>
