...
@section('content')
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">12 People</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-user-alt fa-2x text-gray-300"></i>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                ยกเลิกการผ่อน</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">0 People</div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-user-alt fa-2x text-gray-300"></i>
                        </div>
    ...
    <div class="card shadow mb-4">
        ...
        >จำนวนลูกค้า
            ...
            <div class="card-body">
                <h4 class="small font-weight-bold">ผ่อนไปใช้ไป<span class="float-right">20 People</span></h4>
        ...
        <div class="progress">
            ...
            <div class="card-body">
                <div class="chart-pie pt-4 pb-2">
                    ...
                    <canvas id="myPieChart" width="379" height="245"
                        style="display: block; width: 379px; height: 245px;" class="chartjs-render-monitor"></canvas>
                </div>
