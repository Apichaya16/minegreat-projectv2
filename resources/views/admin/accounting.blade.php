            ...
            <div class="modal-body">
                <form action="{{route('accounting.store')}}" method="POST" id="addAccForm">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="user_id" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุรหัสลูกค้า">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="product" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุชื่อของสินค้าที่ผ่อน">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="brand" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุแบรนด์ของสินค้า">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="details" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุรายละเอียดของสินค้า">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="discount" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุส่วนลดหรือโปรโมชั่นที่ใช้">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="installment" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุจำนวนเงินที่ลูกค้าเปิดบิลผ่อน">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="price" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุราคาผ่อนของสินค้า">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="balance_payment" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="ระบุยอดผ่อนคงเหลือ">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" name="percen_current" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="แสดง % ชำระปัจจุบันของลูกค้า">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" aria-label="First name" name="percen_consider" class="form-control" placeholder="แสดง % การพิจารณา">
                        <input type="text" aria-label="Last name" name="amount_consider" class="form-control" placeholder="แสดงจำนวนเงิน">
                    </div>
